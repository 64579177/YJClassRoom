...
class KiImageClipperViewController: UIViewController {
    ...
    private func creatLeftBtnWithTitle(title:String) {
        if leftBtn == nil {
            ...
            leftBtn?.frame = CGRect(x: 0, y: 0, width: TITLE_BAR_HEIGHT, height: TITLE_BAR_HEIGHT)
    ...
    private func creaRightBtnWithTitle(title:String) {
        if rightBtn == nil {
            ...
            rightBtn?.frame = CGRect(x: 0, y: 0, width: TITLE_BAR_HEIGHT, height: TITLE_BAR_HEIGHT)
